					...
					<div class="card">
						<div class="card-header">
							<div class="card-title">
								<span class="title">MANUTENÇÃO COORDENAÇÃO TI</span>
									   ...
									   <div class="row">
											<div class="col-sm-6">
												<table class="table table-hover">
													...
													<tbody>
														<tr ng-repeat="coordenacaoTI in coordenacoesTI.list | orderBy: 'nome'">
															<td scope="row">{{coordenacaoTI.nome}}</td>
															<td scope="row">{{coordenacaoTI.grupo}}</td>
															<td>
																<button type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#modalAlterar" ng-click="updateCoordenacao(coordenacaoTI)" style="margin-top: -7px; margin-bottom: -7px">editar</button>
																<button type="button" class="btn btn-danger btn-xs" ng-click="deleteCoordenacao(coordenacaoTI.uid)" style="margin-top: -7px; margin-bottom: -7px">excluir</button>
															</td>
														</tr>
													</tbody>
												</table>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<select id="selCoordenacaoTi" 
								class="form-control" 
								ng-options="selSegmentoNegocio.uid as selSegmentoNegocio.descricao for selSegmentoNegocio in segmentoNegocio.list track by selSegmentoNegocio.uid" 
								ng-model="selSegmentoNegocio">
								<option value="">Selecione</option> 
							</select>
							<div class="alert alert-danger error-message" role="alert" ng-show="erroSegmento">
								<strong>Alerta!&nbsp;</strong>{{msgErrorSegmento}}
							</div>
							<br>							
